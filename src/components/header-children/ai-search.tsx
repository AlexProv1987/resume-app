...
export const SearchComponent = (props: SearchCompProps) => {
    ...
    const inputMinLength = 25

    const submitQuestion = () => {
        if (inputVal.length < inputMinLength) {
            setShowError(true);
            return;
        }
        ...
        axiosBaseURL.post('question/ask/', {
            applicant: props.applicant_id,
            question: inputVal,
        }).then(function (response) {
            setAnswer(response.data.answer)
            axiosBaseURL.post('feedback/create/llmresponse', {
                applicant_reltn:props.applicant_id,
                question_text:inputVal,
                        ...
                        <Col xs={12} sm={10} md={8} lg={6}>
                            <Form.Group controlId="questionInput">
                                ...
                                <Form.Control.Feedback type="invalid">
                                    {`Please enter at least ${inputMinLength} characters.`}
